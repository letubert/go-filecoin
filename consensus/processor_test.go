...
func TestProcessTipSetSuccess(t *testing.T) {
	...
	stCid, miner := mustCreateMinerWithOwner(ctx, require, st, vms, minerAddr, minerOwner)
...
func TestProcessBlockBadMsgSig(t *testing.T) {
	...
	minerOwner := address.MakeTestAddress("mo")
	stCid, _ := mustCreateMinerWithOwner(ctx, require, st, vms, minerAddr, minerOwner)
...
func TestProcessBlockReward(t *testing.T) {
	...
	vms := th.VMStorage()
	stCid, _ := mustCreateMinerWithOwner(ctx, require, st, vms, minerAddr, minerOwnerAddr)
...
func TestProcessBlockVMErrors(t *testing.T) {
	...
	stCid, miner := mustCreateMinerWithOwner(ctx, require, st, vms, minerAddr, minerOwnerAddr)
...
func mustCreateMinerWithOwner(ctx context.Context, require *require.Assertions, st state.Tree, vms vm.StorageMap, minerAddr, minerOwner address.Address) (cid.Cid, *actor.Actor) {
